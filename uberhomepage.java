 ...
 */
public class uberhomepage extends javax.swing.JFrame {

    /**
     * Creates new form uberhomepage
     */
    public uberhomepage() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Uber Home Page");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(uberhomepage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new uberhomepage().setVisible(true);
            }
        });
    }
